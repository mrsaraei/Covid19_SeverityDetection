...
pd.DataFrame(f).to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Severity Detection\Prepared Data\f.csv", index = False)
pd.DataFrame(t).to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Severity Detection\Prepared Data\t.csv", index = False)
...
df_f = pd.read_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Severity Detection\Prepared Data\f.csv")
df_t = pd.read_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Severity Detection\Prepared Data\t.csv")
...
pd.DataFrame(df).to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Severity Detection\Prepared Data\df.csv", index = False)
...
# Import DataFrame (.csv) by Pandas Library
df = pd.read_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Severity Detection\Prepared Data\df.csv")
...
df_CML.to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\Results\Severity Detection\All Features\CoV19_Severity_Detection_AutoCML.csv", index = False)
print("")
